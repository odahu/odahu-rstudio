install.packages(
    c(
        ...
        'LaplacesDemon', 'lattice', 'lazyeval', 'leaflet', 'leaps', 'lfe', 'lme4', 'lubridate', 'magrittr',
        'maps', 'markdown', 'MASS', 'Matrix', 'MatrixModels', 'mda', 'memoise', 'methods', 'mgcv', 'mime',
        'miniUI', 'minqa', 'munsell', 'Neuralnet', 'nlme', 'nloptr', 'nnet',
        'parallel', 'PKI', 'plotly', 'plyr', 'PresenceAbsence',
